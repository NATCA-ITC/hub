...
declare module 'vue-router/auto-routes' {
  ...
  export interface RouteNamedMap {
    ...
    'employee-movement': RouteRecordInfo<'employee-movement', '/employee-movement', Record<never, never>, Record<never, never>>,
    'employee-movement-hardship': RouteRecordInfo<'employee-movement-hardship', '/employee-movement/hardship', Record<never, never>, Record<never, never>>,
    'employee-movement-ncept': RouteRecordInfo<'employee-movement-ncept', '/employee-movement/ncept', Record<never, never>, Record<never, never>>,
    'employee-movement-nest': RouteRecordInfo<'employee-movement-nest', '/employee-movement/nest', Record<never, never>, Record<never, never>>,
    'employee-movement-ssr': RouteRecordInfo<'employee-movement-ssr', '/employee-movement/ssr', Record<never, never>, Record<never, never>>,
